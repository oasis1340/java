...
public class Lotto {
	...
	public String[] buyLotto (String job) {
	...
	public void checkLotto (String job, int count) {
		if (job == "회사원" && count == 6) {
	...
	public static void main(String[] args) {
		...
		int count = 0; // lotto1의 로또 번호 맞은 개수
...
//		Job person = new Job("자택 경비원");
		...
		// 직업을 비교해서 로또 번호 받기
		lotto1 = lotto.buyLotto(person.getJob());
...
//		}
		...
		// job이 회사원 또는 연구원일 때만 로또 추첨을 하기 위해서 if문으로 감싸기 
...
//				ex) 1 2 3 -> 3 4 5
			...
			lotto.checkLotto(person.getJob(), count);
		}
